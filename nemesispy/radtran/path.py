...
def interp(x_data, y_data, x_input):
    """
    1D linear interpolation using scipy.interpolate.interp1d.
    Extrapolation is used when x_input is out of range of x_data.
...
def calc_layer(planet_radius, H_model, P_model, T_model, VMR_model, ID, NLAYER,
    path_angle, H_0=0.0, NSIMPS=101,
    layer_type=1, custom_path_angle=0.0,
