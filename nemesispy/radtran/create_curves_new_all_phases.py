...
for iphase,phase in enumerate(phase_grid):
    ...
    if iy == 3:
        ...
        ix += 1
# plt.show()
plt.savefig('corrected_spectra.pdf')
...
for iwave,wave in enumerate(wave_grid):
    axs[iwave].errorbar(phase_grid, data_wave_by_phase[iwave,:,0]*1e3,
                        ...
                        label='Data')
    axs[iwave].plot(phase_grid, my_gcm_wave_by_phase[iwave,:]*1e3,
...
plt.savefig('corrected_phase_curve.pdf')
