...
class Nemesis_api:
    ...
    def _name_spx(self,path_angle=0):
        # FWHM = 0.0
        # LATITUDE = 0.0
        # LONGITUDE = 0
        # NGEOM = 1
    ...
    def write_config_files(self,T_surface,path_angle=0):
        self._noise_dat()
        self._name_abo()
        self._name_cia()
        self._name_fla()
    ...
    def write_files(self, H_model, P_model, T_model, VMR_model,path_angle=0):
        # get to nemesis units
        H_model = H_model * 1e-3
        P_model = P_model/const['ATM']
        self.write_config_files(T_model[0])
    ...
    def read_drv_file(self):
        ...
        self.pressure = pressure * const['ATM'] # convert to Pa
        self.temp = temp
