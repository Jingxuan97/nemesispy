...
### Temperature scale list
T_scale_list = [1.25,1,0.5,0.25]
T_type_list = ['Ultra hot', 'Hot','Temperate','Cold']
...
for index, T_scale in enumerate(T_scale_list):
    ...
    axs[index,0].text(1.3,2.5e-3,"{}".format(T_type_list[index]))
