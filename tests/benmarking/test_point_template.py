...
### Compare output
fig, axs = plt.subplots(nrows=2,ncols=1,sharex=True,dpi=400)

## Upper panel
# Fortran plot
axs[0].plot(wave_grid,spec_fo,color='k',linewidth=0.5,linestyle='-',
    marker='x',markersize=2,label='Fortran')

# Python model plot
axs[0].plot(wave_grid, spec_py,color='b',linewidth=0.5,linestyle='--',
...
axs[1].plot(wave_grid, diff, color='r', linewidth=0.5,linestyle=':',
